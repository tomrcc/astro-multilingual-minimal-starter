...
content_blocks:
  ...
  - _name: TextBlock
    _uuid: f2631fee-f0a5-4445-b79b-cccdf6a52ba0
    heading: List rendering test
    text_content: |-
      A few list shapes to exercise stale detection across markdown's tight/loose
      rendering and CloudCannon's serializer:
      ...
      A list with a multi-paragraph item:

      - This item runs to two paragraphs.

        This second paragraph belongs to the same item.

      - This item is a single line.
---
